...
func TestOIDCConfigFromEnvBindsOrganizationAndWorkspace(t *testing.T) {
	...
	t.Setenv("INTRAKTIBLE_OIDC_SHAUTH_POST_LOGOUT_REDIRECT_URL", "https://intraktible.example.test/auth/shauth/logout/complete")
	...
	if config.PostLogoutRedirectURL != "https://intraktible.example.test/auth/shauth/logout/complete" {
