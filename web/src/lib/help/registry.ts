...
export const HELP = new Map<string, PageHelp>([
  ...
  [
    '/fairlending',
    {
      title: 'Fair lending',
      summary:
        'A disparate-impact report over a flow’s recorded decisions: the adverse-impact ratio (the four-fifths rule of the US Equal Credit Opportunity Act, Regulation B) of favorable-outcome rates across a protected-class attribute you name. A screen over real decisions, not a legal conclusion. Admin only.',
      capabilities: [
  ...
  [
    '/compliance',
    {
      title: 'Compliance',
      summary:
        'The compliance officer’s home: the tenant’s regulatory work in one view — the adverse-action 30-day queue, the human-review audit trail (Article 22 of the EU General Data Protection Regulation), the lawful-basis overview, and, for admins, data-governance holds and retention. Cards degrade per role.',
      capabilities: [
        'See declined decisions awaiting their notice under the US Equal Credit Opportunity Act (Regulation B), with the 30-day clock and overdue rows flagged.',
